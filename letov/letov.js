...
function Letov(lyrics) {
  ...
  function random() {
    var song = Math.floor(Math.random() * lyrics.length);
    var string = Math.floor(Math.random() * lyrics[song].lyrics.length);
    return lyrics[song].lyrics[string] !== undefined ? lyrics[song].lyrics[string] : random();
  }
}

exports.default = Letov;
...
module.exports = [
	{
		"title": "\nFlying HomeПесня проекта «Коммунизм»\n",
		"lyrics": [
	...
	{
		"title": "\nА дальше что?Песня проекта «Коммунизм»\n",
		"lyrics": [
			"Сидели да сидели.",
			"Сидели да сидели.",
			"Взяли и придумали,",
	...
	{
		"title": "\n70 лет ОктябряПесня проекта «Враг Народа»\n",
		"lyrics": [
			...
			"Мы снова поперхулись  ",
			" комочком свободы ",
			"И поспешно притворились ",
			" такими же как все ",
			" Ленин Сталин Маленков Хрущёв",
			" Брежнев Андропов Черненко Горбачёв ",
			...
			"Это-непогрешимость государственной  ",
			" машины",
			" Ленин Сталин Маленков Хрущёв",
			" Брежнев Андропов Черненко Горбачёв "
		]
	...
	{
		"title": "\nА у мира час до полночиПесня группы Инструкция по выживанию\n",
		"lyrics": [
	...
	{
		"title": "\nА я люблюПесня проекта «Коммунизм»\n",
		"lyrics": [
			"Плащом прикрыла плечики,",
			"Дожди идут везде,",
			"А капли как кузнечики,",
			"Стрекочат на воде,",
			"И я дождинку каждую,",
			"В ладонь ловлю,ловлю,",
			"Ты зря не любишь дождика,",
			"А я дожди люблю.",
			"Зима бывает снежная,",
			"Трещит крутой мороз,",
			"А ты такая нежная,",
			"В перчатку прячешь нос.",
			"Летит на лыжах молодость,",
			"Как будто во хмелю,",
			"Ты зря не любишь холода,",
			"А я мороз люблю.",
			"Такая ты красивая,",
			"Как самый первый снег,",
			"Наверно ты счастливее,",
			"Снежинок этих всех,",
			"Ни чем я не прославился,",
			"Себя я не хвалю,",
	...
	{
		"title": "\nАфганский синдромПесня группы Инструкция по выживанию\n",
		"lyrics": [
	...
	},
	{
		...
		"lyrics": [
			...
			"В нашу конституцию впиваются враги",
	...
	{
		"title": "\nБабочки сверкаютПесня проекта «Коммунизм»\n",
		"lyrics": [
			"Бабочки сверкают",
			"Алмазными булавками",
			"Куколки дождались",
	...
	{
		"title": "\nБеспокойное времяпроект «Коммунизм»\n",
		"lyrics": [
			"Во время октябрьских дней,как член ",
			"Петроградского Совета,я дежурил в Смольном",
			"несколько дней подряд.",
			"Раз,около трех часов ночи,заходит в дежурную ",
			"Ильич и спрашивает: «Вы дежурный?»-",
			"«Так точно!»—отвечаю я по-солдатски. -",
			"«А ты сегодня ужинал?» — «Да.» -«Не знаешь",
			" ли,где можно достать хлеба?» — «Знаю,-",
			"говорю я. —Вечером для караула привезли ",
			"свежий хлеб.Если нужно,я пойду и принесу». ",
			"Сказал,и отправился за хлебом. «Нет,не надо»,",
			"—преградил Ильич руками дорогу и,быстро повернувшись,вышел из",
			"комнаты,спустился ",
			"по лестнице и вышел в караульное помещение.",
			"Я еле успевал следовать за ним.В карауле,как на",
			"грех,весь караул спал. «Кто здесь разводящий?»",
			"—спрашивает Ильич.Я указал. Ильич дёрнул ",
			"его за ногу.Тот заворчал...",
			"«Вставай,это я,Ленин».",
			"Рабочий вскочил с нар на ноги и как-то ",
			"испуганно,не то спросонья,ответил: «Чего",
			"изволите?Виноват!» Ильич положил ему руку ",
			"на плечо: «Ничего,ничего.Нет ли у Вас хлеба?»",
			"Разводящий подбежал к шкафу,выхватил ",
			"буханку хлеба и подал Ильичу. «Куда,дорогой,",
			"так много,с меня довольно и одного кусочка»,",
			" — улыбаясь,сказал Ленин.Кусок отрезал.",
			"А спать-то,товарищ,вам не полагается. ",
			"Время беспокойное\",—спокойно уходя,"
		]
	},
	{
		"title": "\nБелые Солдаты\n",
	...
	{
		"title": "\nБабушка живётпроект «Коммунизм»\n",
		"lyrics": [
			"Бабушка жуёт беззубым ртом",
			"Бабушка живёт вчерашним днём",
			"Дедушка катит тележку",
			"Через канаву"
		]
	},
	{
		"title": "\nБелый светПесня проекта «Коммунизм»\n",
		"lyrics": [
	...
	{
		"title": "\nБелорусские книговкипроект «Коммунизм»\n",
		"lyrics": [
			"Птица поёт...",
			"У нас белорусские книговки,",
			"на полях в это время очень уж голосистые.",
			"Они в это время гнёзда свои вьют",
			"и приветствуют что ли нас-работников полей,"
		]
	},
	{
		"title": "\nБольшое удовольствиепроект «Коммунизм»\n",
		"lyrics": [
			"Что же милее всего для человека?",
			"Жизнь:потому что с нею только",
			"связаны все наши радости,",
			"всё наше счастье,все наши надежды."
		]
	},
	{
		"title": "\nБлагодатьпроект «Коммунизм»\n",
		"lyrics": [
			"Вот она-благодать:",
			"Розовые очки, ",
			"Полные пены слова,",
	...
	{
		"title": "\nБогатырский храппроект «Коммунизм»\n",
		"lyrics": [
			"Да. Пять с половиной тысяч бойцов, как один человек, спали вповалку на"
		]
	},
	{
		"title": "\nБесыпроект «Коммунизм»\n",
		"lyrics": [
			"...И когда он прибыл на другой берег,",
			"в страну Гергесинскую,его встретили два",
			"бесноватые,вышедшие из гробов,весьма свирепые,",
			"так что никто не смел проходить тем путём.",
			"И вот они закричали:«Что тебе до нас,Иисус,",
			"сын Божий?Пришёл ты сюда прежде времени",
			"мучить нас!»",
			"Вдали же от них паслось большое",
			"стадо свиней,и бесы просили его:",
			"«Если выгонишь нас,то пошли нас в стадо свиней.»",
			"И он сказал им:«Идите!»И они,вышедши,",
			"пошли в стадо свиное.И вот всё стадо свиней"
		]
	},
	{
		"title": "\nБери шинель\n",
	...
	{
		"title": "\nВ Ленинских горахпесня группы Чёрный Лукич\n",
		"lyrics": [
	...
	{
		"title": "\nВ небе звёзды зажглисьПесня проекта «Коммунизм»\n",
		"lyrics": [
			"В небе звёзды зажглись и кругом темнота",
			"Только кошки не спят,ищут кошки кота.",
			"Как же кошкам помочь,в эту лунную ночь?",
			"Не найти им кота,ведь кругом темнота.",
			"Вот идёт серый кот и печально орёт",
			"Почему он кричит?У него не стоит.",
			"Вот и в жизни порой,возвращаясь домой,"
		]
	},
	{
		"title": "\nВ каждом доме\n",
	...
	},
	{
		...
		"lyrics": [
			...
			"14 чёрных птиц-по пятам за моею спиной",
	...
	{
		"title": "\nВ удивительном мирепроект «Коммунизм»\n",
		"lyrics": [
			"Я родился в октябрьском году",
			"И от этого я не уйду",
			"Ни за что,никуда,никогда",
			"Как от синего неба звезда",
			"Всё отсюда,отсюда,отсюда",
			"Всё отсюда,отсюда,отсюда",
			"Революция удалась",
			"И октябрьская советская власть",
			"Потому мы удачники в главном",
			"В нашем мире родном равноправном"
		]
	},
	{
		"title": "\nВ начале было слово\n",
	...
	{
		"title": "\nВ дурдомепроект «Коммунизм»\n",
		"lyrics": [
			"Дедушка курил самокрутку в туалете",
			"и рассказывал о том,как во сне он"
		]
	},
	{
		"title": "\nВ садикеИстория Гражданской Обороны\n",
		"lyrics": [
			"Как прекрасны цветочки в саду",
			"В день,когда распускаются оныя",
			"Я к природе сегодня иду",
			"В сад,где росточки зелёныя",
	...
	{
		"title": "\nВеликие люди езмьпроект «Коммунизм»\n",
		"lyrics": [
			"Великия люди езмь    ",
			"И живут сии на Земле",
			"И многия они труды пишут",
			"И думают думы главами умными и от всего есть полезныя",
			"А езмь люди-композиторы зовутся и пишут музыки сии",
			"И люди поют и играют сие и мелодика езмь от сего",
			"Я мелодику слухом возслышу",
			"Уломлю сии звуки,возспрямну",
			"И тебе пропою я это,моя дорогая краля",
			"И промолвишь -",
			"Езмь на земли мелодика душевная"
		]
	},
	{
		"title": "\nВесёлые сказкипроект «Коммунизм»\n",
		"lyrics": [
			"Ослабла подпруга    ",
			"Убита подруга",
	...
	{
		"title": "\nВерю,будет...проект «Коммунизм»\n",
		"lyrics": [
			"Мчится краснозвездная ракета",
			"В ярости безумных скоростей",
			"Принимай,далёкая планета",
			"Принимай невиданных гостей",
			"Верю в это скорое свиданье",
			"Вижу серебристые поля",
			"«Кто послал вас?»—спросят марсиане",
			"Им ответят—«Ленина Земля»",
			"Им мои товарищи расскажут",
			"О могучих вихрях наших лет",
			"И на алых книжечках покажут",
			"Чёткий крутолобый силуэт",
			"Мир материкам,планетам,странам",
			"Мы несём с великим Ильичём",
			"Мы и к вам,далёким марсианам",
			"С дружбою пришли,а не с мечом",
			"Верю я:космическим преградам",
			"Не прервать намеченный маршрут",
			"И свой лучший город Ленинградом",
			"Марсиане,знаю,назовут",
			"И везде,где быть подобным встречам",
			"Где промчим на звёздном корабле",
			"Будет наш Ильич увековечен"
		]
	},
	{
		"title": "\nВершки и корешки\n",
	...
	{
		"title": "\nВесёлый танец шейкпесня проекта «Коммунизм»\n",
		"lyrics": [
			...
			"Джек привёз из Лондона весёлый танец шейк",
			"Живут сегодня вместе весёлый Джек и Бетти",
			"И по утрам танцуют веселый танец шейк",
			"Бетти плюс Джек,танцуйте дети шейк",
			"Джек привёз из Лондона весёлый танец шейк"
		]
	},
	{
		"title": "\nВеснаПесня проекта «Коммунизм»\n",
		"lyrics": [
	...
	{
		"title": "\nВладимир Ильичпроект «Коммунизм»\n",
		"lyrics": [
			"«Высшее достижение,которого добился Владимир Ильич,-это в",
			"какой-то степени научился копировать свою подпись.»",
			"«Ильич стал слушать внимательно и своим единственным",
			"словом,которым он хорошо владел,-»вот-вот«,стал делать",
			"замечания во время рассказа.»",
			"«Владимир Ильич принадлежал к тем людям,которые считали, что",
			"необходимо,зная реальное положение вещей,не говорить правду народу,не",
			"говорить правду партии,держать это при себе,а партии и народу"
		]
	},
	{
		"title": "\nВишня,абрикоса...проект «Коммунизм»\n",
		"lyrics": [
			"-Поехали.Сады у вас цветут сейчас во всю,Василий Иванович.",
			"А вот,эти вот,розовые деревца.Это что?",
			"-Это персики.",
			"-Персики?",
			"-Персики.Да.",
			"-А белые это..."
	...
	{
		"title": "\nВосковая куклаПесня проекта «Коммунизм»\n",
		"lyrics": [
	...
	{
		"title": "\nВорошиловпроект «Коммунизм»\n",
		"lyrics": [
			"Е-е,Ворошилов",
			"Е-е,Ворошилов",
			"Е-е,Ворошилов",
			"Маршал СССР",
			"Железный маршал,мира страж",
			"Товарищ Ворошилов",
			"С тобой привычен подвиг наш",
			"Товарищ Ворошилов",
			"Красноармейских звёзд лучи",
			"Огнём пылают и в ночи",
			"От нашей крепости ключи",
			"От нашей крепости ключи",
			"Пусть враг дерзнёт в недобрый час",
			"Наш меч остёр,наш верен глаз",
			"И сила сталинская в нас",
			"Товарищ Ворошилов",
			"Мы встанем грозною стеной",
			"Вдоль рубежей страны родной",
			"Все,как один,готовы в бой",
			"Товарищ Ворошилов",
			"И если грянет битвы зов",
			"Мы тучей глянем на врагов",
			"За свой закон,за мирный кров",
			"Товарищ Ворошилов",
			"Великой дружбою согрет",
			"Народа радостный рассвет",
			"Не счесть,не счесть его побед"
		]
	},
	{
		"title": "\nВоспоминаниеПесня проекта «Коммунизм»\n",
		"lyrics": [
	...
	{
		"title": "\nВот они стоятпроект «Коммунизм»\n",
		"lyrics": [
			"Молодёжь шестидесятых,вот они стоят",
			"Это толпы волосатых девок и ребят",
			"Майки порваны и джинсы,стёртые до дыр",
			"Это наш с тобой свободный"
		]
	},
	{
		"title": "\nВойна\n",
	...
	{
		"title": "\nВсё ещё впередипесня проекта «Коммунизм»\n",
		"lyrics": [
	...
	},
	{
		"title": "\nВсёпроект «Коммунизм»\n",
		"lyrics": [
			"Когда меня спрашивают,что тебе дала "
		]
	},
	{
		"title": "\nВсё могло бы быть иначепесня проекта Коммунизм\n",
		"lyrics": [
			"Боль в твоих глазах",
			"Да,я так устал",
			"За три года тридцать прожил",
			"Так скажи,зачем я должен",
			"Продолжать,что я не начал?",
			"Всё могло бы быть иначе...",
			"Я так добра хотел",
			"Жаль,что не сумел",
			"Оправдать твои надежды",
			"Дай мне силы,чтоб я снова",
			"Стал таким,каким был прежде",
			"Таким как был всегда...",
			"Лишь об одном молю",
			"Я судьбу свою",
			"Дай испить мне эту чашу",
			"Горечь жизни душу ранит,",
			"Но я выпью эту чашу",
			"В час разлуки и печали...",
			"Боль в твоих глазах",
			"Да,я так устал",
			"За три года тридцать прожил",
			"Так скажи,зачем я должен",
	...
	{
		"title": "\nВсё пройдётПесня группы Инструкция по выживанию\n",
		"lyrics": [
	...
	{
		"title": "\nВсё на север(Метаморфоза 1)История Гражданской Обороны\n",
		"lyrics": [
			"Подхватило ураганом",
			"Как заброшенный листок",
			"Как обрушенный песок",
			"Через ветер,через крыши",
	...
	{
		"title": "\nВстречапроект «Коммунизм»\n",
		"lyrics": [
			"Вот однажды один человек пошёл на службу,да по дороге встретил другого",
			"человека,который,купив польский батон, направлялся к себе восвояси."
		]
	},
	{
		"title": "\nВстречапесня проекта «Коммунизм»\n",
		"lyrics": [
			"Река закачала луну на волне,",
			"И сумерки сразу упали на плечи,",
			"Ты снова пришла на свиданье ко мне,",
			"А мне на любовь отвечать больше не чем.",
			"Ты любить спеши,",
			"Не то весна пройдёт,",
			"А пройдёт не ворожи,",
			"Любовь не ждёт,",
			...
			"Ей рано погаснуть и не куда падать,",
			...
			"Заверенье как прощанье,",
			"Заверенье как прощанье.",
			"И катится прошлая грусть на волне,",
			"Разлуки-прощанья,свиданья и встречи,",
			"Но тает твой профиль в густой синеве,",
			"И мне на любовь отвечать больше не чем.",
			"Ты любить спеши,",
			"Не то весна пройдёт,",
			"А пройдёт не ворожи,",
			"Любовь не ждёт,",
	...
	{
		"title": "\nВыбор предковпроект «Коммунизм»\n",
		"lyrics": [
			"«Утверждают,что человек произошёл от обезъяны... А вот если"
		]
	},
	{
		"title": "\nГде Цюрбертпроект «Коммунизм»\n",
		"lyrics": [
			"-Где Цюрберт?",
			"-Значит ,не хотите отвечать,где Цюрберт?"
		]
	},
	{
		"title": "\nГде восстание?проект «Коммунизм»\n",
		"lyrics": [
			"-Я вот только слыхал,Никита Егорыч,что на вашу волость посланы",
			"японцы.Так-слух есть.Что восстание там...",
			"-Где?",
			"-Как где?..",
			"-Где восстание?Какое восстание?Где восстание?",
			"-Ну как где,Никита Егорович?",
			"-Да никакого восстания.Да не было нигде там.Там.Где-то там.Двух"
		]
	},
	{
		"title": "\nГавна—пирогаПесня проекта «Коммунизм»\n",
		"lyrics": [
			"Залезая на крест    ",
			"Христом не грейся",
			"Погост на руки",
			...
			"Закопали в огород",
			"Гавна-Пирога",
			"Гоголь плачет в гробу ",
			"И рвётся наружу",
			"Из резиновых зайчиков",
			"Выходит воздух",
	...
	{
		"title": "\nГолемпроект «Коммунизм»\n",
		"lyrics": [
			"Вложи в уста мом(мои) свой шэм    ",
			"И вздрогни(внемли)-я взгорю звездою",
			"Звездой любви к тебе святою",
			"Прекрасной розовой зарёю",
			"Я не сгорю-я вечно греть",
			"Тебя любовею сей(этой) буду",
			"Где-б ни была ты",
			"Вечно",
			"Всюду"
		]
	...
	{
		"title": "\nГлаз как алмазпроект «Коммунизм»\n",
		"lyrics": [
			"Глаз как алмаз",
			"А рот как унитаз",
			"Если дёрнуть за нос",
			"То от теда хлещет кровища",
			"Как вода"
		]
	},
	{
		"title": "\nГолубые погоныПесня проекта «Коммунизм»\n",
		"lyrics": [
			"Наливайте бокалы золотистого рома,",
			"Кто сейчас на гражданке приказа не ждёт",
			"Наливайте за наши голубые погоны",
			"И летящий по небу голубой самолёт.",
			"Голубые погоны цвета мирного неба",
			"Голубые погоны-частица земли",
			"Их не дарят на память,не дают по наследству",
			"Голубые погоны-это трудные дни.",
			"Далеко от порога,от родимого дома",
			"Мать с девчонкой вздыхают,всё вздыхают и ждут ",
			"И пока в своих письмах они нежно целуют,"
		]
	},
	{
		"title": "\nГород детства\n",
	...
	{
		"title": "\nГосподи,не надыть!проект «Коммунизм»\n",
		"lyrics": [
			"Старенький бабушка",
			"Старенький дедушка",
			...
			"Старенький дедушка",
			"В дверочку звонит",
			"Смотрит на бабушку и улыбается",
			"Дверь открывается",
			"- Здравствуйте!",
			"- Здравствуйте.",
			"- Вы продаёте собрание сочинений Канта?",
			"- Что вы!",
			"- Ну как же...",
			"- Нет, нет, ошибаетесь.",
			"- Разве? Позвольте...",
	...
	{
		"title": "\nГолубые макиПесня проекта «Коммунизм»\n",
		"lyrics": [
			"Мне вчера приснилось",
			"Голубое поле",
			"Поле на котором не растёт трава",
			...
			"Голубые маки,как твои глаза.",
			"Голубые маки",
			"К нам пришли из сказки",
			"Сказки у которой,нет совсем конца",
			"Только голубые-голубые маки"
		]
	},
	{
	...
	{
		"title": "\nДалеко бежит дорога (впереди веселья много)Песня группы «Чёрный Лукич»\n",
		"lyrics": [
			"Мы идём в тишине",
			"По убитой весне",
			"По разбитым домам",
	...
	{
		"title": "\nДа здавствует любовь!проект «Коммунизм»\n",
		"lyrics": [
			"Живи,пока живётся",
			"Пока играет кровь",
			"Крути мальчишкам головы"
		]
	},
	{
		"title": "\nГлина научит\n",
	...
	{
		"title": "\nДвое друзейпроект «Коммунизм»\n",
		"lyrics": [
			"Было двое друзей у меня,",
			"Во всём на меня похожих.",
			"Умер один.",
			"А другой"
		]
	},
	{
		"title": "\nДва годапроект «Коммунизм»\n",
		"lyrics": [
			"Прошу тебя ты только не плачь",
			"Прошу тебя два года подождать ",
			"Пройдёт весна растает белый снег",
			"И я к тебе вернусь на целый век",
			"Ну что с тобой и слёз полны глаза ",
			"Поверь,что два года-это ерунда ",
			"Прошу тебя ты только не грусти",
			"Прошу тебя два года подожди",
			"Прошу пиши мне пару слов ",
	...
	},
	{
		"title": "\nДезертир\n",
		"lyrics": [
			"А кармы безобразный ком немое горло разодрал-дезертир",
			"А обобщения изгадили мои слова-дезертир",
			"Кривые нежности изранили моё лицо-дезертир",
			"Слепые комплексы меня согнули пополам-дезертир",
			" В нагромождениях",
	...
	{
		"title": "\nДембеляПесня проекта «Коммунизм»\n",
		"lyrics": [
	...
	{
		"title": "\nДело было вечеромпроект «Коммунизм»\n",
		"lyrics": [
	...
	{
		"title": "\nДневники #1проект «Коммунизм»\n",
		"lyrics": [
			"В его затылке вырезали сегментообразный кусок.Вместе с солнцем туда",
			"заглядывает весь мир.Это нервирует его,отвлекает от работы,кроме",
			"того,его злит,что именно он должен быть исключён (выключен) из"
		]
	},
	{
		"title": "\nДембельская\n",
	...
	{
		"title": "\nДождьпроект «Коммунизм»\n",
		"lyrics": [
			"Вот однажды в дождик заступил в наряд ",
			"Отчего-то вспомнил свой родимый край,",
			"А у нас ведь тоже часто дождь бывает,",
			"А такой вот дождик красным называют",
			"Часто вспоминаю милые глаза ",
			"Я о тебе родная день и ночь мечтаю ",
			"Знаю не дождёшься с кем-то загуляешь",
			"В страсти с ним сольёшься я ведь это знаю",
			"И с другим в постели,глупо улыбаясь, ",
			"Вспомни о солдате,вспомни я ведь знаю ",
			"Бить тебя не стану,оболью презрением ",
			"Для меня была ты два года вдохновением"
		]
	},
	{
		"title": "\nДетский мир\n",
	...
	},
	{
		...
		"lyrics": [
			...
			" как заграничный рукомойник,",
			"Они всё время рассказывали мне",
			" одну и ту же сказку",
			" и глаза их блестели на солнце",
			" как грязные жирные пальцы",
			"Деревья кричали пернатыми пауками",
			"На них развешивали мокрые тряпки",
			" и крамольные трупы"
		]
	},
	{
		"title": "\nДневники #2проект «Коммунизм»\n",
		"lyrics": [
			"Кажется,самое подходящее место,для того чтобы вонзить нож,—между",
			"шеей(горлом) и подбородком. Поднимаешь подбородок и вонзаешь нож в",
			"напряжённые мышцы.Но это только кажется,будто оно самое",
			"подходящее.Надеешься увидеть,как великолепно хлынет кровь и порвётся"
		]
	},
	{
		"title": "\nДитё\n",
	...
	{
		"title": "\nДрузья,за работу!проект «Коммунизм»\n",
		"lyrics": [
			"Над нашею сторонкою поют,поют гудки,",
			"Им вторят песни звонкие,легки и широки.",
			"Идёт бригада дружная,задорней не найдёшь.",
			"Кто всех впереди?",
			"Кто с весельем в груди?",
			"Это мы—трудовая молодёжь!",
			"Нам солнце приветливо светит,",
			"И ветер веселый поёт,",
			"Друзья,за работу,",
			"Друзья,за работу!",
			"Нас подвиг трудовой зовёт.",
			"Зовут нас дали новые на славные дела.",
			"Зовёт тайга суровая,Алтай и Ангара.",
			"С бригадой молодёжною повсюду ты пройдёшь.",
			"Кто всех впереди?",
			"Кто с весельем в груди?",
			"Это мы—трудовая молодёжь!",
			"Могучими моторами разбудим сон степей,",
			"Откроем недра горные для Родины своей,",
			"С бригадой молодёжною нигде не пропадёшь.",
			"Кто всех впереди?",
			"Кто с весельем в груди?",
			"Это мы — трудовая молодёжь! "
		]
	...
	{
		"title": "\nЕсли б Богом я былПесня проекта «Коммунизм»\n",
		"lyrics": [
			"Если б",
			"Богом я бы был,",
			"То я знал бы,",
	...
	},
	{
		...
		"lyrics": [
			...
			"Я—строительный матерьял",
			"Я—полезный инструмент,",
			"Я—наглядный эксперимент",
			" Мне велели—я ответил«Есть!»",
			"Я общественный унитаз",
			"Я общественный половик",
			"Я общественный автомат",
			"Я общественное жраньё."
		]
	},
	{
		"title": "\nЖёлтая пресса\n",
	...
	{
		"title": "\nЖенщина и смертьпроект «Коммунизм»\n",
		"lyrics": [
			"Зачем любить?",
			"Зачем гореть?",
			"Зачем в глаза",
	...
	{
		"title": "\nЖизнь трудна,но,к счастью,короткапроект «Коммунизм»\n",
		"lyrics": [
			"Доктор Калембет,отбывший пять лет ",
			"своего лагерного срока, не справился ",
			"с послелагерной волей и через год ",
			"покончил с собой,оставив записку:",
			"«Дураки жить не дают».",
			"* * * * * * *"
		]
	},
	{
		"title": "\nЖивём в счастливомпроект «Коммунизм»\n",
		"lyrics": [
			"Советская власть,партия большевиков ",
			"создала для нашей советской молодёжи",
			"счастливую радостную культурную ",
			"жизнь!Наша молодёжь не знает ",
			"эксплуатации,она не знает физического ",
			"и морального угнетения! Вот почему ",
			"молодёжь всего мира нас с вами,",
			"товарищи,считает самой счастливой ",
			"молодёжью,самым счастливым ",
			"поколением рабочих и крестьян!",
			"Мы живём счастливо!Мы вправе ",
			"называть себя счастливым поколением,",
			"потому что нас воспитала партия Ленина,",
			"она дала нам возможность работы,"
		]
	},
	{
		"title": "\nЖивотворящий сладкий сок любви и радостиПроект «Коммунизм»\n",
		"lyrics": [
	...
	{
		"title": "\nЖитьпроект «Коммунизм»\n",
		"lyrics": []
	},
	{
		"title": "\nЖуки-мозгиПесня проекта «Коммунизм»\n",
		"lyrics": [
	...
	},
	{
		...
		"lyrics": [
			...
			"Аки потом пити охота от них?",
			"А потом я вкусил тортику",
			"Но не доел я сего",
			"Так ли вкусно нам сладости",
			"Коли уж тошно с него?",
	...
	{
		"title": "\nЖизнь как сметанаПесня проекта «Коммунизм»\n",
		"lyrics": [
			"Подвязать штаны",
	...
	{
		"title": "\nЗелёный блюзИстория Гражданской Обороны\n",
		"lyrics": [
			"О сладкий сладкий клавиш",
			"Зелёный навсегда",
			"Мой драгоценный клавиш",
			"Зелёный как всегда",
			"Когда тебя надавишь",
			"У-ша-ба-да-ба-да!",
			"Сегодня очень туго",
			...
			"Ушла моя подруга",
			"У-ша-ба-да-ба-да!",
			"Сегодня очень грязно",
			"Какие холода",
			"И очень вдруг прекрасно",
			"Но это не беда",
			"Увы,я ждал напрасно"
		]
	},
	{
		...
		"lyrics": [
			...
			"Параллельно коммунизму речка алая текёт",
			"Незабвенная свобода во свинцовом во гробу",
			...
			"Ветеран Афганистана победил свово врага            ",
			" В пламенной стране",
			" С каждым годом дальше-больше",
			" Если я такой живой—убей меня любер",
			" Я—еврей,убей меня -член общества «Память»",
	...
	{
		"title": "\nЗасиделся за костромпроект «Коммунизм»\n",
		"lyrics": [
	...
	},
	{
		...
		"lyrics": [
			...
			"Бродили яко по суху по талой воде",
	...
	{
		"title": "\nЗдравствуй,трудпроект «Коммунизм»\n",
		"lyrics": [
	...
	},
	{
		...
		"lyrics": [
			...
			"Хранят сокровища всемирной культуры",
			" Культуры зомби",
	...
	{
		"title": "\nИ сказки расскажут о васПесня проекта «Коммунизм»\n",
		"lyrics": [
	...
	{
		"title": "\nИгра в самолётики под кроватьюпроект «Коммунизм»\n",
		"lyrics": [
			"Речи замедляются",
			"Слова повторяются",
	...
	{
		"title": "\nКак принять гостя по-монгольскиПесня проекта «Коммунизм»\n",
		"lyrics": [
	...
	{
		"title": "\nКонцептуализм внутриПесня проекта «Коммунизм»\n",
		"lyrics": [
			...
			"Завсегда нам это было нипочём и панка",
			"И африканская птица-секретарь",
			"Никита Сергеевич Хрущев плачет рубахой",
			"Андропов плачет и не вытирает слёз",
			"Черненко хотел заплакать,но умер",
			"Нам не вынести этих сладостных грёз",
			" ОТКРОЙ ",
			" И ПОСМОТРИ",
			" КОНЦЕПТУАЛИЗЬМ ",
			" ВНУТРИ!",
			"Жалабно плачут Троцкий и Бухарин",
			"Рыдает Дзержинский и товарищ Свердлов",
			"И даже Лаврентий Павлович Берия всплакнул украдкой",
			"И даже высморкался в клетчатый платок ",
			"И был таков.",
			" ОТКРОЙ ",
			" И ПОСМОТРИ",
			" КОНЦЕПТУАЛИЗЬМ ",
			" ВНУТРИ!",
			"Не читали они наших книг",
			"Не смотрели они наших кин",
			"Не слыхали они наших роков"
		]
	},
	{
		"title": "\nКак жить\n",
	...
	{
		"title": "\nКолбаса,Донбасс и яПесня проекта «Коммунизм»\n",
		"lyrics": [
			"Баба Шура жопа мыло",
			"Колбаса,Донбасс и я",
			"Новый год утюг какашка"
		]
	},
	{
		"title": "\nКого я больше всех люблюпроект «Коммунизм»\n",
		"lyrics": [
			"Люблю я Крым,люблю Кавказ"
		]
	},
	{
		"title": "\nКакое мне дело\n",
	...
	{
		"title": "\nКрасный сонКвартирник у Саши «Иваныча» Рожкова\n",
		"lyrics": [
			"Я вижу калеченный день,",
			"Я вижу народную срань,",
			"Я вижу потуги нетонущих граждан",
			"Я вижу собачую кровь,",
			"Я вижу холодную сыпь",
			"Никто,никому,ничего,никогда",
			" Мне приснился красный сон",
			"В желудке плавает чай,",
			"В поле растёт молочай,",
			"Болота воняют резиновой спермой",
			"В глухом изнурённом нутре",
			"Разлагается гнойный срыг",
			"И никто из вас больше никогда",
			" Мне приснился красный сон",
			"Воспалённый скорченный день,",
			"Сырая народная срань,",
			"Тупые потуги нетонущих граждан",
			"Густая собачая кровь,",
			"Стальная холодная сырь",
			"И никто из вас больше никогда"
		]
	},
	{
		"title": "\nКоммунизм №1проект «Коммунизм»\n",
		"lyrics": []
	},
	{
		"title": "\nКапуста\n",
		"lyrics": [
			"Умирал заснеженно и натужно"
		]
	},
	{
		"title": "\nКогда я умер/Анафемапроект «Коммунизм»\n",
		"lyrics": [
			"Когда я умер",
			"Плевком замёрзли",
			"Дорогие конструкции",
			...
			"Фатально лежу.",
			"P.S.",
			"-лицо ярко-розовое,потом бледное;",
			"-головная боль,головокружение,ощущение",
			"пульсации в висках(«стучит»),тошнота,иногда рвота;",
			"-одышка,сердцебиение,слабость,расстройство",
			"движений;",
			"-помрачение сознания,резкая мышечная слабость,",
			"сонливость;",
			"-ослабление дыхания,потеря сознания,судороги,",
			"слюнотечение,прикусывание языка,"
		]
	},
	{
		"title": "\nКонкретная музыка #3 Что такое советская власть?проект «Коммунизм»\n",
		"lyrics": []
	},
	{
		"title": "\nКолыбельнаяПесня проекта «Коммунизм»\n",
		"lyrics": [
			...
			"С ним цветы цветут.",
			"Голубой идёт не долго,"
		]
	},
	{
		"title": "\nКоммунизм №2проект «Коммунизм»\n",
		"lyrics": [
	...
	{
		"title": "\nКак я за хлебом ходилпроект «Коммунизм»\n",
		"lyrics": [
			"Я проснулся утром,сильно болела голова.",
			"Я пошарился в карманах:там было двадцать копеек.",
			"Я одел свои штаны,вышел во двор и пошёл за хлебом.",
			"Мой путь лежал мимо цветущего сада.",
			"По небу плыли пушистые облака,а в песочнице играли дети.",
			"В тёплых лужах отражалось синее небо",
			"И мелькали весёлые птицы.",
			"Когда я переходил рельсы,трамвай перерезал мне голову.",
			"Я лежал и думал:"
		]
	},
	{
		...
		"lyrics": [
			"Меня сорвало с неба",
			"Меня сорвало с ветви",
			"И ветер тщетно ищет",
			"Куда б меня закинуть",
			"Ведь для него я-",
			" лишь кленовый лист",
			" лишь кленовый лист",
			" лишь бродячий дождь",
			" лишь осенний кот",
			"Толпа идёт навстречу",
			"Толпа идёт слепая",
			"И каблуками давит",
			"Моё лицо, как дыню",
			"Ведь для неё я-",
			...
			" лишь бродячий дождь",
			" лишь осенний кот",
			"Пока я плакал кровью",
			"Подкрались тихо дети",
	...
	{
		"title": "\nКогда идёшь ты на свиданиепроект «Коммунизм»\n",
		"lyrics": [
	...
	},
	{
		...
		"lyrics": [
			...
			"Мой день пyтан пpоволокой и зимой",
			...
			" КОГО-ТО ЕЩЁ",
			"Опyхшая мякоть внyтpи нас гниёт",
			"Внyтpи плесневеет змеей пyлемёт",
			...
			" Похоже,что это нехватка",
			" КОГО-ТО ЕЩЁ",
			"Колючая пpоволока и вощще",
			"Блажен кто лежит на кладбище",
			"На всех не хватило,но нам всё pавно",
			"И мы все выжиpаем любое говно",
			" Похоже,что это надолго",
			" Похоже,что это повадка",
			" Похоже,что это yловка",
			" Похоже,что это нехватка"
	...
	{
		"title": "\nКонкретная музыка #2  А вы знаете?проект «Коммунизм»\n",
		"lyrics": [
			"— Нууу, молодые люди...Приходиться просто удивляться,что вы не знаете",
			"таких простых вещей,честно слово.",
			"— А вы знаете?",
			"— Я?"
		]
	},
	{
		"title": "\nКоронаПесня группы Инструкция по выживанию\n",
		"lyrics": [
			...
			"Нежный и жадный,и жесткий,как жизнь",
			"Тех,кто взошёл к эшафоту судьбы",
	...
	{
		"title": "\nКонкретная музыка #4 Усыпесня проекта «Коммунизм»\n",
		"lyrics": [
	...
	{
		"title": "\nЛебедь белаяпроект «Коммунизм»\n",
		"lyrics": [
			"По реке бурлистой и широкой",
			"Лебедь белая плывёт",
			"И в клюве своём широком"
		]
	},
	{
		"title": "\nЛюбви Не МиноватьПесня проекта «Коммунизм»\n",
		"lyrics": [
	...
	{
		"title": "\nЛенин умерпроект «Коммунизм»\n",
		"lyrics": [
			"Наш Ленин,мысли великан,скончался."
		]
	},
	{
		"title": "\nЛюсиПесня проекта «Коммунизм»\n",
		"lyrics": [
			"Мы поедем в лес с тобой,будто бы за цветами",
			"И возьмем Люси с собой,пусть она будет с нами",
			"Па-пара-ба-па-ба-бам",
			"Собираем мы цветы,а сова хохочет",
			"Я зову Люси в кусты,а она не хочет",
			"Па-пара-ба-па-ба-бам",
			"Ах,ты,милая Люси,будешь ты моею",
			"Подойди скорей ко мне,я тебя согрею",
			"Па-пара-ба-па-ба-бам",
			"Вот и кончилась давно вылазка за цветами",
			"Так и нету ничего с Люськой между нами",
			"Па-пара-ба-па-ба-бам",
			"Па-пара-ба-па-ба-бам"
		]
	},
	...
	{
		"title": "\nКто в России не бывалПесня проекта «Коммунизм»\n",
		"lyrics": [
			"Кто в России не бывал ",
			"Тот и света не видал ",
			"Приезжайте к нам ",
	...
	{
		"title": "\nКуда же ты скрыласьПесня проекта «Коммунизм»\n",
		"lyrics": [
			"Душа ни по ком до сих пор не томилась",
			"Но ты повстречалася мне,",
			"Куда же ты делась,куда же ты скрылась,",
			"Неужто приснилась во сне?",
			"Но если ты даже мне только приснилась",
			"Имей,дорогая,ввиду",
			"Куда б ты ни делась,куда б ты не скрылась",
			"Тебя наяву я найду.",
	...
	},
	{
		...
		"lyrics": [
			...
			"Назову её Мариной.",
			"В доме тишина.Комочек он плакучий",
			"Спит угомонясь.",
			"Думами себя,любимая,не мучай,",
			"Выслушай меня.",
			"Ты назови её Мариной,",
			"Созвучье города и леса,",
			"В нём- отголосок Марсельезы,",
			"И деревенская волынка,",
			"Назови её Маринкой.",
			"Матовый рассвет дотронется украдкой",
			"До закрытых глаз.",
			"Маленькая дочь потянется к кроватке",
			"И разбудит нас.",
			"Мы назовём её Мариной,",
			"Ведь это имя- в нас обоих.",
			"В нём зов мятежного прибоя",
			"И звон подсвечников старинных."
		]
	},
	{
		"title": "\nМарш бригад коммунистического трудаПесня проекта «Коммунизм»\n",
		"lyrics": [
			"Нас партия делу учила,",
			"В работу пустила страна,",
			"И вот она,мощная сила —",
			"Рабочих успехов волна.",
			"Чтоб все были бодры и рады,",
			"Чтоб нужд не осталось следа,",
			"Вперёд,молодые бригады",
			"Коммунистического труда!",
			"Мы к технике руки приложим,",
			"Мы сердце с металлом сольём,",
			"И нет ничего,что не сможем",
			"Осилить в движеньи своём.",
			"Мы в грёзах пустых не витаем,",
			"Природы подарков не ждём,",
			"Мы новое изобретаем,",
			"Мы будущее создаём.",
			"Чтоб все были бодры и рады,",
			"Чтоб нужд не осталось следа,",
			"Вперёд,молодые бригады",
			"Коммунистического труда!",
			"В заводе,в ученье и в поле,",
			"На вольных морях,на земле,",
			"Мы все обучались в той школе,"
		]
	},
	{
		"title": "\nКуда Мы Есть\n",
	...
	{
		"title": "\nМальчик фашистПесня проекта «Коммунизм»\n",
		"lyrics": [
	...
	{
		"title": "\nМарш коммунистических бригадПесня проекта «Коммунизм»\n",
		"lyrics": [
			"Будет людям счастье,",
			"Счастье на века;",
			"У Советской Власти",
	...
	{
		"title": "\nМалиновая скалаИстория Гражданской Обороны\n",
		"lyrics": [
	...
	{
		"title": "\nМитрополит ИпполитПесня группы Цыганята и я с Ильича\n",
		"lyrics": [
			"Митрополит Ипполит ",
			"Митрополит Ипполит ",
			"Митрополит Ипполит "
	...
	{
		"title": "\nМарш энтузиастовПесня проекта «Коммунизм»\n",
		"lyrics": [
	...
	{
		"title": "\nЛюбовь—не картошкаПесня проекта «Коммунизм»\n",
		"lyrics": [
	...
	{
		"title": "\nМало солнышка да долгие ноченькипроект «Коммунизм»\n",
		"lyrics": [
			"Мало солнышка- вот всё объяснение русской истории.",
			"Да долгие ноченьки.Вот объяснение русской"
		]
	},
	{
		"title": "\nМанифестпроект «Коммунизм»\n",
		"lyrics": [
			"Вся мудрость и вси заботы хлебороба,",
			"заключается в том,что",
			"в этом деле нужно каждый день"
		]
	},
	{
	...
	{
		"title": "\nМиф о загробной жизнипроект «Коммунизм»\n",
		"lyrics": [
	...
	{
		"title": "\nМеткий выстрелпроект «Коммунизм»\n",
		"lyrics": [
			"это — обезьяна...смотри-смотри, какую рожу скорчила...наш дом"
		]
	},
	{
		"title": "\nМимикрия\n",
	...
	{
		"title": "\nМолодёжнаяПесня проекта «Коммунизм»\n",
		"lyrics": [
	...
	{
		"title": "\nМоё селоПесня проекта «Коммунизм»\n",
		"lyrics": [
	...
	{
		"title": "\nМоя северная странаПесня группы Инструкция по выживанию\n",
		"lyrics": [
	...
	{
		"title": "\nМы Америку догоним на советской скорости!Песня проекта «Коммунизм»\n",
		"lyrics": [
			"Кукуруза,кукуруза,",
			"Да гибридная,",
			"По всему ты по Союзу",
			"Стала видная.",
			"Потеснись,ячмень усатый,",
			"И овёс нечёсаный,",
			"Кукуруза нам богатство",
			"Принесёт по осени.",
			"На Оке и на Кубани,",
			"Да на Тереке реке",
			"Кукуруза лучше станет,",
			"Чем в Америке.",
			"Мы характером спокойны,",
			"Да зато напористы—",
			"Мы Америку догоним",
			"На советской скорости.",
			"Нас пугали—мы не трусы,",
			"Не пугаемся,",
			"Всех побить по кукурузе",
			"Постараемся!",
	...
	{
		"title": "\nМоя странаПесня проекта «Коммунизм»\n",
		"lyrics": [
			"Цветут необозримые ",
			"Колхозные поля. ",
			"Огромная,любимая, ",
	...
	{
		"title": "\nНароды!проект «Коммунизм»\n",
		"lyrics": [
			"Народы,хотите ли я вам скажу громовую истину,какую",
			"вам не говорил ни один из пророков...",
			" — Ну?Ну?..Хх..",
			" -Это– что частная жизнь выше всего.",
			" — Хе-хе-хе!..Ха-ха-ха!..Ха-ха!..",
			" — Да,да,да! Никто этого не говорил;я – первый...",
			"Просто сидеть дома и хотя бы ковырять в носу",
			"и смотреть на закат солнца.",
			" — Ха,ха,ха..",
			" — Ей-ей:это общее религии...Все религии пройдут,а это"
		]
	},
	{
		"title": "\nНа Исходе Днябонус к альбому СЛО\n",
		"lyrics": [
	...
	{
		"title": "\nНапряг растётИстория Гражданской обороны\n",
		"lyrics": [
			"Растёт напряг",
			"Напряг растёт",
			"Растёт напряг",
			...
			"И вот уже ",
			"Который год",
			"Эх,ма!Болит головёнка",
			"Мне бы снять трусы",
			"Раздеться догола",
			"И головою вниз",
			"Туда,где милая",
			"Но уж который год",
			"Растёт напряг,напряг растёт",
			"И я уже не тот",
			"И милая-постылая",
			"Растёт напряг",
			"Напряг растёт",
	...
	{
		"title": "\nНародоведениепроект «Коммунизм»\n",
		"lyrics": [
			"Племя дикарей отравилось мясом и погибло в страшных судорогах на",
			"деревенской площади.",
			"Два этнолога летали над джунглями,снимали цветной фильм о стране и её",
			"людях",
			"и по этим съемкам написали книгу «Метаморфозы тела в ритуальных"
		]
	},
	{
		"title": "\nНадо брать дворец!проект «Коммунизм»\n",
		"lyrics": [
			"- Владимир Ильич,Николаевский вокзал взят!"
		]
	},
	{
		"title": "\nНа край землипроект «Коммунизм»\n",
		"lyrics": [
			"В автобусе или троллейбусе ехал простой человек.Он был совсем",
			"обыкновенный.",
			"В поношенной телогрейке,в поношенных валенках,в поношенном сером лице.",
			"Он держал полиэтиленовый или целлофановый пакет с печеньем,пряниками",
			"и,",
			"скорее всего,апельсинами. Я был в данном случае контролёром автобуса",
			"или",
			"троллейбуса,а может быть,и кондуктором. Я спросил его: «Куда Вы",
			"едете?»",
			"«На край земли»-ответил он.Я сказал ему:«Вот Ваш билет,",
			"куда Вы едете?»"
		]
	},
	{
	...
	{
		"title": "\nМы будем умирать(А вы наблюдать)\n",
		"lyrics": [
			"Мы будем умирать,а вы- наблюдать",
			"Мы будем умирать,а вы- наблюдать",
			"Мы будем умирать,а вы- наблюдать",
			"Мы будем умирать,а вы- наблюдать",
			"Сладостная юность -золотые деньки",
			"Сладостная юность -золотые деньки",
			"Мы будем умирать,а вы- наблюдать"
		]
	},
	...
	{
		"title": "\nНам не страшен серый волкПесня проекта «Коммунизм»\n",
		"lyrics": [
	...
	{
		"title": "\nНа блаженном острове коммунизмаПесня группы Цыганята и я с Ильича\n",
		"lyrics": [
			"На блаженном острове коммунизма",
			"Красные,сочные ягоды–",
			"из жопы,прямо в рот.",
			"Без гнева и пристрастия кучкуются строители",
			"Напевно торжествуя вечный мужественный взмах",
			"До рождения и старше юбилея православья",
			"До рождения и старше Котлована Чевенгур",
			"Шоу кукольных персонажей",
			"На плантациях бригады выходного дня",
			"Похороны в хозяйственной сумке",
			"Сквозь сокращения ради дела",
			"Уже кажется поздно?– спросила она",
			"Ответ затерялся,ещё не вернулись",
			"Но дети говорили злит их другое"
		]
	},
	{
		"title": "\nНа северепроект «Коммунизм»\n",
		"lyrics": [
	...
	},
	{
		...
		"lyrics": [
			...
			"Запретите мне",
			"Всё равно уже кайф прошел"
		]
	},
	{
		"title": "\nНародная молвапроект «Коммунизм»\n",
		"lyrics": [
	...
	{
		"title": "\nНаташкаПесня проекта «Коммунизм»\n",
		"lyrics": [
	...
	{
		"title": "\nНебо тёмно-синееПесня проекта «Коммунизм»\n",
		"lyrics": [
			"Небо тёмно-синее,время к ночи клонится,",
			"Не послушать сердце ли,не пройти ль околицей?",
	...
	{
		"title": "\nНебо цвета мяса,когда ты споткнулся о мёртвую мышьпроект «Коммунизм»\n",
		"lyrics": [
			"Небо цвета мяса",
			"Когда ты споткнулся "
		]
	...
	{
		"title": "\nНевский проспектПесня группы Цыганята и я с Ильича\n",
		"lyrics": [
			"Парики,шиньоны,косы",
			" Очки",
			"Книги,овощи и фрукты",
			" Продукты",
			"Ремонт,аэрофлот,кинотеатры",
			" Сосиски",
	...
	},
	{
		...
		"lyrics": [
			...
			"Дорога пряма и светла?",
			"Ну как не запеть,если ждут на пути",
			"Любовь и большие дела?",
			"Ну как не запеть,если радость придёт",
			"Подскажет для песни слова?",
			"Ну как не запеть,если с нами поёт"
		]
	},
	{
		"title": "\nНет тебя прекраснейПесня проекта «Коммунизм»\n",
		"lyrics": [
	...
	{
		"title": "\nО жизни чёрных негровПесня проекта «Коммунизм»\n",
		"lyrics": [
			"И никто вокруг не знает,как бедный негр живёт",
	...
	{
		"title": "\nНовогодний тостПесня проекта «Коммунизм»\n",
		"lyrics": [
	...
	{
		"title": "\nНож в спинуПесня группы Инструкция по выживанию\n",
		"lyrics": [
			"Я в этом городе жил",
	...
	{
		"title": "\nНикогдапроект «Коммунизм»\n",
		"lyrics": [
			"Кто не был в армии суровой",
			"И не провёл там юные года",
			"И не мечтал о девушке любимой"
		]
	},
	{
		"title": "\nОптимизм\n",
	...
	{
		"title": "\nОпоздавшая молодёжьПесня группы Цыганята и я с Ильича\n",
		"lyrics": [
			"Был,что не был– умер,встал",
			"Вышел,да не глянул– сползли зрачки",
			"Но из кожи в узел– обязательно быть",
			"Не быть нельзя,а будешь– смех",
			" Опоздавшая  молодёжь",
			"Чтобы догонять– прокусить забор",
			"Чтобы подгонять– вынырнуть из глаз",
			"Склизлые надежды прорастают в шар",
			"Круглыми годами собирать плоды",
			" Опоздавшая молодёжь",
			"Почти подбираясь,хватаясь почти",
			"Аж ногами топнув,глазами зырк",
			"Ликованная вуаль обогреет до слёз",
			"Плахами мхов громыхает гимн",
			" Опоздавшая молодёжь",
			"Эвоно поле блескучих чудесов",
			"Добрейшего зова орлистая стать",
			"Прогеройный стык казырных мудрот",
			"Пожирая очавкло слюняво с губ "
		]
	},
	{
		"title": "\nОбрывпроект «Коммунизм»\n",
		"lyrics": [
	...
	{
		"title": "\nНочьПосвящается Александру Введенскому\n",
		"lyrics": [
	...
	},
	{
		...
		"lyrics": [
			...
			"Три месяца в России я жила."
		]
	},
	{
		"title": "\nОдин и тот же сонпроект «Коммунизм»\n",
		"lyrics": [
			"Трижды удостоенный ",
	...
	{
		"title": "\nОпасностьпроект «Коммунизм»\n",
		"lyrics": [
			"Когда ты даришь розочку,смотри не уколись"
		]
	},
	{
		"title": "\nНовый 37-й\n",
	...
	{
		"title": "\nОгромноепроект «Коммунизм»\n",
		"lyrics": [
			"- Нам вот всё представляется вечность как идея,которую понять",
			"нельзя,что-то огромное,огромное!Да почему же непременно огромное?И",
			"вдруг,вместо всего этого, представьте себе,будет там одна",
			"комнатка,эдак вроде деревенской бани,закоптелая,а по всем углам",
			"пауки,и вот и вся вечность.",
			"А почем знать,может быть,это и есть справедливое,и знаете,я бы так"
		]
	},
	{
		...
		"lyrics": [
			...
			"В трамваях пробивали проездной талон",
			"В подъездах экономили электросвет",
			" Один день Ивана Ивановича ",
			" Один день Ивана Ивановича",
			" Один день Ивана Ивановича",
			" Один день Ивана Ивановича",
			"На стройку успевали завозить раствор",
			"В больницах успевали принимать больных",
			...
			"В трамваях пробивали проездной талон",
			"В подъездах экономили электросвет",
			" Один день Ивана Семёновича",
			" Один день Ивана Кирилловича",
			" Один день Ивана Ивановича",
	...
	{
		"title": "\nПапа римский пригласилПесня группы Цыганята и я с Ильича\n",
		"lyrics": [
			"Папа Римский пригласил",
			"Нас в Италию с тобой.",
			"Папа Римский пригласил",
			"Нас в Италию с тобой.",
			"Папа Римский пригласил",
			"В Италию.",
	...
	{
		"title": "\nПаричокпроект «Коммунизм»\n",
		"lyrics": [
			"-Владимир Ильич!..Пора...!",
			"-Да,да.Иду.",
			"-Владимир Ильич!Паричок-то возьмёте?",
			"-Нет.Не возьму.Нам теперь прятаться не нужно.Власть мы берём всерьёз и"
		]
	},
	{
		"title": "\nПесня красноармейца\n",
	...
	{
		"title": "\nПесня-это главное,друзьяПесня проекта «Коммунизм»\n",
		"lyrics": [
			"Каждый вечер зажигаются огни,",
			"Каждый вечер к нам приходят песни.",
			"И неважно,кем придуманы они –",
			"Важно то,что с ними интересней.",
			"Даже,если едешь в дальние края",
			"По пескам и по снегам глубоким,",
			"За простором за далёким",
			"Ты не будешь одиноким –",
			"С песней одиноким быть нельзя.",
			"На любой земной работе",
			"И в космическом полёте",
			"Песня–это главное,друзья.",
			"В мире много замечательных вещей,",
			"Безусловно,нужных и полезных:",
			"От невидимых рентгеновских лучей",
			"До гвоздей,всем видимых,железных.",
			"И моторы нам нужны,и тормоза,",
			"И пирог с начинкою творожной.",
			"Но без этого несложно,",
			"Даже год прожить возможно,",
			"А без песен дня прожить нельзя.",
			"И при солнце,и при звёздах,",
			"Словно хлеб и словно воздух,",
			"Песня–это главное, друзья.",
			"Человек идёт впервые в детский сад",
			"И встречает песню на пороге.",
			"Хоть нелёгкая дорога у солдат,",
			"Помогает песня им в дороге.",
			"С ней влюблённые глядят глаза в глаза",
			"В уголке любом земного шара.",
			"Есть бульвар,и нет бульвара,",
			"Есть гитара,нет гитары –",
			"С песней расставаться нам нельзя.",
			"От линейки пионерской",
			"До скамьи пенсионерской",
			"Песня–это главное,друзья,",
			"Песня–это главное,друзья!"
		]
	},
	{
		"title": "\nПесня о китайском народном  добровольцеПесня проекта «Коммунизм»\n",
		"lyrics": [
	...
	{
		"title": "\nПервомайское посланиеПроект «Коммунизм»\n",
		"lyrics": [
			"Товарищи,идёт весна",
			...
			"Пусть льется в жёлобе вода",
			"На наших мельницах всегда",
			"Найдется жерновам еда",
			"Наш урожай велик — привет!",
			"Сталь Сулейман безмерно рад",
			"Какая жизнь настала,брат",
			"Такое время вышло,брат"
		]
	},
	{
		"title": "\nПесня о товарище СталинеПесня проекта «Коммунизм»\n",
		"lyrics": [
			"Живое двигая вперёд,",
	...
	{
		"title": "\nПесня о героях(конникам,участникам пробега вокруг кавказского хребта)Песня проекта «Коммунизм»\n",
		"lyrics": [
	...
	{
		"title": "\nПесенка велосипедистовПесня проекта «Коммунизм»\n",
		"lyrics": [
	...
	{
		"title": "\nПесня из К/Ф «Белое солнце пустыни»Песня проекта «Коммунизм»\n",
		"lyrics": [
	...
	},
	{
		...
		"lyrics": [
			...
			"Праздничный шопот в мышиной норе",
			...
			"Промах Акелы,усталость металла,не",
			" -скончаемость вечера после войны.",
			" Это — вечная награда"
		]
	},
	{
	...
	{
		"title": "\nПесенка о капелипесня проекта «Коммунизм»\n",
		"lyrics": [
	...
	{
		"title": "\nПанк и Рок-н-роллИсторя Гражданской Обороны\n",
		"lyrics": [
			...
			"Я жду,пока начнётся ядрёная война",
			...
			"А встал и снова на небосводе солнце"
		]
	},
	{
		"title": "\nПередозировка\n",
	...
	{
		"title": "\nПлохо человеку одномуПроект «Коммунизм»\n",
		"lyrics": [
			"Если мы с тобой сдружились",
			"Раздружаться ни к чему",
			"Потому что очень плохо",
			"Человеку одному",
			"Если твой дружок уехал",
			...
			"Чтоб жила в моём дому",
			"Потому что очень плохо",
			"Человеку одному",
			"Ты цени друзей хороших",
			"И люби их потому",
			"Потому что очень плохо"
		]
	},
	...
	{
		"title": "\nПо поводу поджога колхозного сена кулакамиПесня проекта «Коммунизм»\n",
		"lyrics": [
	...
	{
		"title": "\nПластинкипроект «Коммунизм»\n",
		"lyrics": [
			"Олег сказал,что я Христос с пластинками под мышкой."
		]
	},
	{
		"title": "\nПобеда\n",
	...
	{
		"title": "\nПовесть о настоящем человекеПроект «Коммунизм»\n",
		"lyrics": [
			...
			"странный комок палого листа.Он тронул рукой — комок был тяжёлый и  не",
			"рассыпался.Тогда он стал обрывать листья  и  накололся  на  торчавшие",
			"сквозь них иглы.Он догадался:ёжик.Большой старый  ёж,  забираясь  в",
			"чащу куста на  зимовку,для  тепла  накатал  на  себя  палых  осенних",
			"листьев.Безумная радость овладела Алексеем.Весь свой  скорбный  путь",
			...
			"заставлял себя убирать пистолет.Он не имел права рисковать.",
			" А тут кусок мяса сам попал к нему в руки.Ни минуты не задумываясь,",
			...
			"Алексей убил ежа,развернул его,неумело  содрал  жёлтую  шкурку  на",
			"брюшке и иглистый панцирь,рассёк на части и с наслаждением стал рвать",
			"зубами еще тёплое,сизое,жилистое мясо,плотно приросшее к костям.Ёж",
	...
	{
		"title": "\nПоследнее письмоПроект «Коммунизм»\n",
		"lyrics": [
	...
	{
		"title": "\nПонимаетеПроект «Коммунизм»\n",
		"lyrics": [
			"Вот идёшь в столовую,на столе листовки.В дверь заходишь —"
		]
	},
	{
		"title": "\nПолон дом говна\n",
	...
	{
		"title": "\nПривет вождю,привет солнцуПесня проекта «Коммунизм»\n",
		"lyrics": [
	...
	{
		"title": "\nПорывПроект «Коммунизм»\n",
		"lyrics": [
			"-Ишим только ещё в берега начинает входить..лёд..снег..Я",
			"туда.Приезжаю..Всё там:лодки,это стоят,меряют..Старики",
			"местные,казахи,с белыми бородами бросаются в воду..вот так значит"
		]
	},
	{
		"title": "\nПотомуПроект «Коммунизм»\n",
		"lyrics": [
			"Мы оптимисты потому,что верим в свою партию,знаем путь, который она"
		]
	},
	{
		"title": "\nПоймаю маленького самПроект «Коммунизм»\n",
		"lyrics": [
			"Мне пришлось быть в карауле ",
			"по охране здания рабоче-крестьянского ",
			"правительства.Стоял у входа в квартиру",
			"тов. Ленина.Было два с половиной ",
			"часа ночи.",
			"Вдруг слышу голос и возню.Отворилась ",
			"дверь,и я увидел: что-то пробежало ",
			"беленькое.И увидел Владимира Ильича",
			"и сразу понял,что он ловит котёнка.",
			"Мы встретились взглядами и улыбнулись.",
			"Я сказал: «Разрешите поймать вам котёнка»,",
			"а Ильич отвечает: «Ничего-ничего,поймаю ",
			"маленького сам».После некоторых усилий",
			"Владимир Ильич поймал котёнка, взял ",
			"его на руки,слегка поклонился и ушёл",
			"в квартиру.Я остался на посту,размышляя",
			"о происшедшем. Оказывается,",
			"он и в мелочах был настойчив",
			"и доводил даже всякое мелочное "
		]
	},
	{
		"title": "\nПолный пиздец\n",
		"lyrics": [
			...
			"Забитые говном унитазы,на которыx влезают",
			"ногами,чтобы не испачкать чистую белую жопу.",
			"На заблёванном цементном полу тут и там",
			"валяются ломтики жареной ветчины — их давят",
			"башмаками и ладонями.Воздух белый густой.",
			"У окна стоит группа людей — они курят,",
			"сморкаются и смеются.На подоконнике молодая",
			"мамаша пеленает своё дитя,сплошь покрытое",
			"коричневой сыпью.На окне,замазанном зелёной",
			"краской,твёрдые блестящие решётки.В углу,",
			"левее унитазов,на ржавой трубе висит",
			"очередной повешенный.От него пахнет.",
			"Сбоку надпись кирпичом-"
		]
	},
	{
		"title": "\nПро любовь\n",
	...
	},
	{
		...
		"lyrics": [
			...
			" Во имя опасных,во имя заразных,",
			" Во имя крамольных — ВО ИМЯ МЕНЯ"
		]
	},
	{
		"title": "\nПримусПесня проекта «Коммунизм»\n",
		"lyrics": [
			"Тебе,наш гость,во всех краях",
			"Слова привета говорят",
			"Стоит в углу на трёх ногах",
			"В папахе света аппарат",
			"От спички он огонь берёт",
			"Он керосин пудами жрёт",
			"И,как по морю пароход",
			"Идёт по свету аппарат",
			"Красив,дороден,знаменит",
			"Во тьме он греет и блестит",
			"Разбейте лампы,пусть горит",
			"Как солнце лета,аппарат",
			"Любой из нас,разинув рот",
			"Его в минуту разведёт",
			"Московский выпустил завод",
			"Послушный этот аппарат",
			"Привёз чеканщик Тивикул",
			"Тебя недавно в наш аул",
			"Теперь звучит твой ровный гул",
			"В душе поэта,аппарат",
			"Прельщает пеньем соловей",
			"Петух царит в семье своей",
			"Тебе подобных меж вещей",
			"Конечно нету,аппарат",
			"Тебя зажжёшь,потом уснёшь",
			"А ты варить не устаёшь",
			"Ах,с колесом фортуны схож",
			"По всем приметам аппарат",
			"Не задирай,однако,нос",
			"Хоть Сулейман тебя вознёс",
			"Но это не совсем всерьёз",
	...
	{
		"title": "\nПро мальчика,невидимый трамвай(по рельсам ходит и надвигается,как стебель) и веточкуПроект «Коммунизм»\n",
		"lyrics": [
			...
			"А в окна веточки опавшия печальны",
			"Так просто по ветру печальны — вот и всё",
			"Летят в окошки голосами восьмиклассниц кричат,что умирают,мол...",
			"Да где там...",
			"А завтра в школе мальчик однокашкин отдаст последний комсомольский им",
			"салют",
			"Вчера ещё он пионэром был,а сёдня уж веточки сажает,как большой",
			"Ему неловко веточку сухую держать осеменённою рукой",
			"Глаза он прячет в пазуху (малую) да выползают глазы из-под брюк",
			"Глядят,как будто в женской раздевалке увидели припухлости каки -",
			"само собой понятно есть секреты,которые нуждаются в скорейшем",
			"уничижении",
			"путём оглазки оных ближайшей статуе иль ямке небольшой — Слезинки",
			"оросят",
			"сухую землю — да,кстати (иль не кстати),но сказать,что вроде как и не",
			"земля то вовсе",
			"А всё-ж земля сухих газетных корок,что по весне бывают",
			"Ну так вот,слепую землю оросив,слезинки невоспитают жизненныя силы и"
		]
	},
	{
		"title": "\nПривыкать\n",
	...
	{
		"title": "\nПро иголки и калиткипроект «Коммунизм»\n",
		"lyrics": [
	...
	{
		"title": "\nПро чудо-чудесаПесня проекта «Коммунизм»\n",
		"lyrics": [
	...
	{
		"title": "\nПрогулка в горыПроект «Коммунизм»\n",
		"lyrics": [
			"Не знаю,— воскликнул я беззвучно,— я же не знаю.Раз никто не идёт,так",
			"никто и не идёт.Я никому не сделал зла,мне никто не сделал зла,но",
			"помочь мне никто не хочет.Никто,никто.Ну и подумаешь.Только вот никто",
			"не поможет мне,а то эти Никто-Никто были бы даже очень приятны.Я бы",
			"очень охотно— почему нет?— совершил прогулку в компании таких",
			"Никто-Никто.Разумеется,в горы,куда же ещё?Сколько их,и все они",
			"прижимаются друг к другу,сколько рук,и все они переплелись,сплотились",
			"вместе,сколько ног,и все они топчутся вплотную одна к другой.Само",
			"собой,все во фраках. Вот так мы и идём.Ветер пробирается всюду,где",
			"только между нами осталась щелочка.В горах дышится так"
		]
	},
	{
	...
	{
		"title": "\nПрощай,прощай,моя ТатьянаПроект «Коммунизм»\n",
		"lyrics": [
			"Я ухожу,и я вернусь",
			"И пусть моя любовь останется с тобой",
			"За долгие два года,которые нас разлучают",
			"Никто тебя не встретит и словом ласковым не назовёт",
			"Я знаю,тебе трудно,тебе сейчас одной",
			"Ты стала одинокой и замкнута душой",
			"Но верь в меня,как в человека",
			"Который за эту долгую разлуку",
			"Ещё сильнее полюбил тебя",
			"Поверь,Татьяна,это не слова",
			"Которыми разбрасывают очень часто",
			"Моя любовь крепка,и никогда она не угаснет",
			"Ты от меня сейчас далёко",
			"Но не забыть мне облик твой",
			"Пройдут два года незаметно",
			"И я вернусь к тебе родной",
			"А здесь,сейчас,стон от морозов",
			"И ветры дуют день и ночь",
			"Ты жди меня,родная",
			"И верь,пожалуйста,в любовь",
			"В любовь разлука не страшна",
			"Она умеет ждать и верить"
		]
	},
	{
		...
		"lyrics": [
			...
			"Под землёй — святой underground встречает день",
	...
	{
		"title": "\nПушка не виноватаПроект «Коммунизм»\n",
		"lyrics": [
			"Сел самолёт на аэродроме",
			"Вышел молоденький лётчик Ли",
			"Шёл он сердито нахмуривши брови",
			"Лётчики все к другу подошли",
			"Что с тобой??",
			"От чего ты грустишь пилот???",
			"Ведь ты был весёлым всегда",
			"А нынче ты совсем не тот",
			"Печальный полный забот",
			"В чём же скажи твоя беда???",
			"В чём же скажи нам твоя беда???",
			"Злюсь я на то,что не так стреляю",
			"Целюсь я точно по рукаву",
			"Пушка моя очевидна плохая",
			"Вот от чего плохо я живу",
			"Что ж голубчик ты быть  может не виноват",
			"Что в цель не попал в этот раз",
			"Но почему пять раз подряд снаряды мимо летят",
			"Это узнаем мы сейчас",
			"Это узнаем мы все сейчас",
			"Что бы узнать хороша ли пушка",
			"Сел в самолёт командир полка",
			"Трижды попал он в рукав потому что,",
			"Точен прицел меткого стрелка",
			"Ваша пушка не виновата товарищ Ли",
			"Виновен неловкий стрелок",
			"Сейчас увидеть вы могли",
			"Снаряды в цель все легли",
			"Пусть это будет вам урок",
			"Пусть это будет для вас урок",
			"Начал усиленно Ли учится",
			"Тысячу раз проверял прицел",
			"В небе неслась легкокрылая птица",
			"Каждый снаряд в цель свою летел",
			"Ай да парень молодчина",
			"Лихой пилот",
			"И пушка твоя хороша",
			"И хищный вражий самолёт в бою снаряд твой собьёт",
			"Недругов страны круша,всех врагов смело круша"
		]
	},
	{
		"title": "\nПускпроект «Коммунизм»\n",
		"lyrics": []
	},
	{
		"title": "\nПроглаженный железным утюгомИстория Гражданской Обороны\n",
		"lyrics": [
			"Покрытый щетиной",
			"Усталый недвижный",
			...
			"Мячик играл вазелиновый",
			"Небо кружилось на пальце",
			"На фоне окна он казался",
			"Фанерной мишенью по пояс-",
	...
	{
		"title": "\nПусть всё будет такПесня проекта «Коммунизм»\n",
		"lyrics": [
			"Опять пришла весна и деревья распускаются",
	...
	{
		"title": "\nПяли-муррПесня проекта «Коммунизм»\n",
		"lyrics": [
			"По моим да по гладким мозгам",
			"Языком да шершавым",
			"Славное море священный байкахстъ",
			"Я злого дядьку не боюся",
			"А по утрам да по тошным мирром",
			"Я подхожу до свидания тётя",
	...
	{
		"title": "\nРазвлечения Ильича в ссылке были преимущественно спортивного характера.Проект «Коммунизм»\n",
		"lyrics": [
			"Развлечения Ильича в ссылке были",
			"преимущественно спортивного характера.",
			"Особенно страстно он любил охоту и рыбную",
			"ловлю.У Ильича не было специальных брюк",
			"для болотной охоты ,и он ходил ",
			"на охоту вобыкновенных,что было ",
			"не совсем удобно.Наконец,собравшись",
			"со средствами,Ильич заказал себе болотные ",
			"брюки.Когда их принесли,и он увидел,",
			"что они застёгиваются на одной пуговице,",
			"он сильно смутился,воскликнул:",
			"-Да я ведь потеряю их...",
			"С трудом успокоили тогда Ильича,указав,",
			"что все крестьяне носят такие брюки ",
			"и не теряют их.Впоследствии Ильич часто"
		]
	},
	{
		"title": "\nПять мальчиковПроект «Коммунизм»\n",
		"lyrics": [
			"Пять мальчиков,",
			"Пять чуланчиков.",
			"Разошлися мальчики",
	...
	{
		"title": "\nРазгрохаюсь насмертьПроект «Коммунизм»\n",
		"lyrics": [
			"Очень важно мне пройти,вот по этому бревну,",
			"которое висит высоко над землёй.Если я упаду,то я разгрохаюсь"
		]
	},
	{
		"title": "\nРазговор с девочкойПроект «Коммунизм»\n",
		"lyrics": [
			"Тянется собрание,длятся прения...",
	...
	{
		"title": "\nРадоваться жизниПесня проекта «Коммунизм»\n",
		"lyrics": [
	...
	{
		"title": "\nРассказ неизвестногопроект «Коммунизм»\n",
		"lyrics": [
			...
			"трудное для меня и тяжёлое. Я знаю, что они спрашивают от любви и",
			"хотят помочь мне, но я этих вопросов боюсь ужасно. Разве всегда знают"
		]
	},
	{
		"title": "\nРадостно на душеПроект «Коммунизм»\n",
		"lyrics": [
	...
	{
		"title": "\nРассказ об одном человекеПроект «Коммунизм»\n",
		"lyrics": [
			"Жил один рыжий человек,у которого не было глаз и ушей. У него не было",
			"и волос,так что рыжим его называли условно. Говорить он не мог,так как",
			"у него не было рта.Носа тоже у него не было.У него не было даже рук и",
			"ног.И живота у него не было,и спины у него не было,и хребта у него не",
			"было,и никаких внутренностей у него не было.Ничего не было! Так что",
			"непонятно,о ком идёт речь."
		]
	},
	{
		"title": "\nРваные бусы(СМЕРЧ)Исторя Гражданской Обороны\n",
		"lyrics": [
	...
	{
		"title": "\nРодина — СмертьПесня группы Инструкция по выживанию\n",
		"lyrics": [
	...
	{
		"title": "\nСразу бездыханнапроект «Коммунизм»\n",
		"lyrics": [
			"Я не зря спесивый",
			"Очень я красивый",
			"Глянет лишь кохана",
	...
	{
		"title": "\nСпасипесня проекта «Коммунизм»\n",
		"lyrics": [
			"Тётю Катю,тётю Наташу",
			"Тётю Машу,тётю Парашу",
			"Тётю Любу,Варю и Сашу",
			"И Олю,и Таню,и Надю",
			"Дядю Петю и Колю",
			"Дядю Володю и Гришу,и Сашу",
	...
	{
		"title": "\nТиоремапроект «Коммунизм»\n",
		"lyrics": [
			"Теорема.Дано: ",
			"Положи и знай,не забывай",
			"Формулу такую -",
			"Сумма двух влюблённых губ",
			"Равна поцелую",
			"Доказательство:",
			"Нету лета без июля",
			"Нету мая без цветов",
			...
			"Следствие первое:",
			"Кто боится поцелуя",
			"Тот старается не любить",
			"Ведь любовь без поцелуя",
			"Никогда не может жить",
			"Следствие второе:",
			"Ревность — глупость,это факт",
	...
	},
	{
		...
		"lyrics": [
			...
			"Умерщвлённого множеством звёзд",
			"Множеством звёзд собравшихся в стаю",
			"В хищную стаю голодных кобелей",
			"Голодных кобелей ищущих суку",
			"Одну только суку на всех кобелей",
			"Взбесившихся в сладостных снах",
			"праведников",
			"В кельях влачащих слюнявую веру",
			"Радостно прячущих библию за спину",
			"при виде голых грудастых девок,ползущих",
			"на культях отрубленных ног,вспоминающих",
			"резвые сильные пальцы,оставлявших",
			"канавки струящихся мышц в жирной грязи",
			"деревенских околиц,молчаливых околиц",
			"взорвавшихся сёл,бескрайних околиц и",
			"сгнивших погостов,заброшенных удочек в",
			"синее море.Поднялись бабы навстречу члену,"
		]
	},
	{
		"title": "\nСпатьПесня группы Цыганята и я с Ильича\n",
		"lyrics": [
			"Жировать,пировать – спать",
			"Голодовать,слюни глотать – спать",
			"Пировать,голодовать – спать"
		]
	},
	{
		"title": "\nТост о женщинах-физикахпроект «Коммунизм»\n",
		"lyrics": [
			"Женщины-медики пьют до потери пульса",
			"Женщины-химики— до потери реакции",
	...
	{
		"title": "\nСолнечная Грузияпесня проекта «Коммунизм»\n",
		"lyrics": [
			"Солнечная Грузия ",
			"Милый мой Кавказ ",
			"Там гора высокая ",
			"Я овечек пас ",
			"Что бы не случилось заводил я вальс ",
			"Что бы не случилось танцевал я джаз ",
			"Лай лай даш ",
			"Туше дашь туше ",
			"Джана джана йаш ",
			"Туше Грузия моя ",
	...
	},
	{
		...
		"lyrics": [
			...
			" обратной дороги нет",
			" обратной дороги нет ",
			"нет уж лучше ты послушай как впивеется",
			" в ладони дождь",
	...
	{
		"title": "\nСолдатский сонпесня проекта «Коммунизм»\n",
		"lyrics": [
	...
	{
		"title": "\nСон инженера ЖЭУ—5проект «Коммунизм»\n",
		"lyrics": [
			"Инженеру ЖЭУ-5 снится сон,ни дать,ни взять"
		]
	},
	{
		"title": "\nСолнце взойдет\n",
	...
	{
		"title": "\nТост о юностипроект «Коммунизм»\n",
		"lyrics": [
			"Девушки!Любите солдата хотя бы за то,"
		]
	},
	{
		"title": "\nСтих инспектора Савченко №2проект «Коммунизм»\n",
		"lyrics": [
	...
	{
		"title": "\nУеду в АмерикуИстория Гражданской Обороны\n",
		"lyrics": [
	...
	{
		"title": "\nЧудо-музыкапесня проекта «Коммунизм»\n",
		"lyrics": [
			"Чудо-музыка пришла сегодня в дом, ",
			"Мы под музыку и спляшем,и споём. ",
	...
	{
		"title": "\nСтоп для Роллинг Стоунзпесня проекта «Коммунизм»\n",
		"lyrics": [
	...
	{
		"title": "\nСибирский морозИстория Гражданской Обороны\n",
		"lyrics": [
			"Окно замёрзло — стальной мороз",
			"Часы застыли — и свет погас",
			"Замёрзло время,замёрзла кровь",
			"Для нас настала полярная ночь",
			"Страна замёрзла под властью льда",
			"Страна замёрзла под властью сна",
			"Страна застыла под властью лжи",
			"Страна подохла и снег упал",
			"Забейте двери",
			"Заткните щели",
			"Зажгите костёр"
		]
	...
	{
		"title": "\nСерёжапроект «Коммунизм»\n",
		"lyrics": [
			"Который раз пишу тебе,Серёжа",
			"Истосковалась по тебе,сыночек мой",
			"А ты пишешь,что скучаешь тоже",
			"И в сентябре воротишься домой",
			"А за окном у нас стоят цыгане",
			"Они гадают на тебя,сыночек мой",
			"А та девчонка с карими глазами",
			"Давно,Серёжа,ждёт тебя домой",
			"Придёшь домой,облепят словно пчёлы",
			"«Скажите,тётя,как у Серёженьки дела?»",
			"У одной поблёскивают слёзы",
			"Видать,заела ту молодушку тоска",
			"Пришла весна,все выгнали скотину",
			"Зазеленела в поле сочная трава",
			"А ту рябину,что у нас стояла",
			"Пахан срубил по пьянке на дрова",
			"Пришёл сентябрь,ты пишешь мне Серёжа",
			"Ты,мама милая,домой меня не жди",
			"Суд лагерей судил меня по новой",
			"За то,что мы с дружком порезали конвой",
			"И срок нам дали огромный-преогромный"
		]
	},
	{
		"title": "\nСияние\n",
	...
	},
	{
		...
		"lyrics": [
			...
			" влезая в очки ",
			"Мутнею осенней тучей,содрагаюсь  ",
			" и прячу лицо",
			"Я чувствую себя не в своих штанах "
		]
	},
	...
	{
		"title": "\nЯ не магпесня проекта «Коммунизм»\n",
		"lyrics": [
			"Ты в эту ночь не спишь,",
			"Ты обо мне грустишь",
			"Фея милая,родная,",
			"Обо мне грустишь,я знаю",
			"Обо мне грустишь",
			"Ты позови меня, ",
			"Я в тот же миг приду",
			"Сколько дней мы не встречались",
			"В нашем стареньком саду",
			"Позови и я приду",
			"Я рядом быть хочу, ",
			"В мыслях к тебе лечу",
			"С неба звёзды собираю, ",
			"Подарить тебе,родная,",
			"Все созвездия я хочу",
			"Ах,мне б хотелось так, ",
			"В сказках бывает как",
			"В волшебство готов поверить, ",
			"Чтоб открылись к счастью двери",
			"Но к несчастью я не маг"
		]
	},
	{
...
var _output = __webpack_require__(1);

var _output2 = _interopRequireDefault(_output);

var _letov = __webpack_require__(0);

var _letov2 = _interopRequireDefault(_letov);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

window.Letov = (0, _letov2.default)(_output2.default);
...
var _letovBrowserify = __webpack_require__(0);

var _letovBrowserify2 = _interopRequireDefault(_letovBrowserify);
